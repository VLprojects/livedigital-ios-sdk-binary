...
extension L10n {
	...
	static let registerInCRSServiceHint = L10n("registerInCRSServiceHint")
	static let phoneNumberPlaceholder = L10n("phoneNumberPlaceholder")
	static let signIn = L10n("signIn")
	static let signOut = L10n("signOut")
